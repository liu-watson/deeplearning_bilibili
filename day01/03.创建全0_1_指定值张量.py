...
print(f"t3:{t3}, type:{type(t3)}") # 3行2列全1矩阵
print("*" * 30)
...
print(f"t3:{t3}, type:{type(t3)}") # 3行2列全255矩阵
print("*" * 30)

# 场景3:torch.full 和 torch.full_like创建全为指定值张量
t1 = torch.full(size=(2, 3), fill_value=255) # 创建2行3列全0张量
print(f"t1:{t1}, type:{type(t1)}")
print("-" * 30)
